...
var AppComponent = /** @class */ (function () {
    function AppComponent() {
        this.title = "Mean Stack, Front to Back";
    }
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            ...
            providers: [_services_validate_service__WEBPACK_IMPORTED_MODULE_15__["ValidateService"], _services_auth_service__WEBPACK_IMPORTED_MODULE_16__["AuthService"], _guards_auth_guard__WEBPACK_IMPORTED_MODULE_17__["AuthGuard"]],
...
module.exports = "<h1 class=\"page-header\">Your Dashboard</h1>\n"
...
module.exports = "<!-- make sure there's a user -->\n<div *ngIf=\"user\">\n  <h2 class=\"page-header\">{{ user.name }}</h2>\n  <ul class=\"list-group\">\n    <li class=\"list-group-item\">Username: {{ user.username }}</li>\n    <li class=\"list-group-item\">Email: {{ user.email }}</li>\n  </ul>\n</div>\n"
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        this.authService.registerUser(user).subscribe(function (data) {
            if (data.success) {
                ...
                _this.flashMessage.show("Unable to register. Please try again.", {
                    cssClass: "alert-danger"
                });
                //redirect
...
module.exports = __webpack_require__(/*! /Users/charlesmartinreed/Development/Web Development/Javascript/Stacks/MEAN/basic-mean-stack-demo/angular-src/src/main.ts */"./src/main.ts");
